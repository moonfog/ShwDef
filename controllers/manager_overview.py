...
def overview_guests():
    ...
    if len(guest_errors)==0:
        ...
        grid = SQLFORM.grid(db.guest,fields=fields,deletable=False,editable=False,details=False,paginate=10,create=False,csv=True,exportclasses=dict(csv=(CSVExporter, 'CSV'),csv_with_hidden_cols=False,xml=False,html=False,json=False,tsv_with_hidden_cols=False))
...
############ probeersels moeten nog beter uitgewerkt worden #####
def search_guest():
